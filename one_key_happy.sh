...
if [ -f ${plugin_file} ];then
    ...
    wget https://gitee.com/xiaofengzhiyu/btpanel-v7.7.0-install/raw/main/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://gitee.com/xiaofengzhiyu/btpanel-v7.7.0-install/raw/main/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://gitee.com/xiaofengzhiyu/btpanel-v7.7.0-install/raw/main/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://gitee.com/xiaofengzhiyu/btpanel-v7.7.0-install/raw/main/repair.json
